...
int main(){
	...
	while(input != 0) {
		...
		cout << "3. Circulo condutor com carga na circunferencia (2D)" << endl;
		cout << "4. Circulo isolante com carga na superficie (2D)" << endl;
		cout << "5. Semiplano infinito condutor com densidade de cargas na superficie (2D)" << endl;
		cout << "6. Semiplano infinito isolante com densidade de cargas na superficie (2D)" << endl;
