...
public class Livro
{
     ...
     */
     ...
     //construtor inicializando, por padrao, o ano de publicacao como 2019
    ...
    //método que solicita dados do usuário para a criação de uma instancia de Livro, inserindo-a no arrayList estático da classe
    ...
    //método para a remoção de uma instancia de Livro do arrayList da classe, usando o isbn como elemento de busca
