...
public class Biblioteca{
    ...
    public void consultaDiasLocacao(Livro livro){
         for(Livro auxLivro : this.listaLivros){
            if(livro.getIsbn().equals(auxLivro.getIsbn())){
                if(livro.getQtdCopias() == 0){
                    System.out.println("Não há cópias do livro");
                    ...
                    System.out.println("O livro poderá ser locado por um periodo de " + livro.getPeriodoLocacao()/2 + "dias");
                }else{
                    System.out.println("O livro poderá ser locado por um periodo de " + livro.getPeriodoLocacao() + "dias");
                }
            }
        }
    }

    public void consultaDiasLocacao(Artigo artigo){
        for(Artigo auxArtigo: this.listaArtigos){
            if(auxArtigo.getTitulo().equals(artigo.getTitulo())){
                if(artigo.getQtdCopias() == 0){
                    System.out.println("Não há cópias do artigo");
                }else if(artigo.getAnoPublicacao() == "2020"){
                    System.out.println("O artigo poderá ser locado por um periodo de " + artigo.getPeriodoLocacao()/4 + "dias");
                }else{
                    System.out.println("O artigo poderá ser locado por um periodo de " + artigo.getPeriodoLocacao() + "dias");
                }
            }
        }
    }
