 ...
 * partir do índice, todos os livros guardados em páginas cujo valor de ano_publicação esteja
...
bool consultaFaixaAnosUtil(int a1, int a2, bool exists, int index, int profundidade, int offset, char filename[21]) {
    ...
    if(!exists) {
        ...
        for(int i = 0; i < n_livros; i++) {
            ...
            if(l.ano_publicacao >= a1 && l.ano_publicacao <= a2) {
                achou = true;
                printf("%s\n", l.autor);
                printf("%s\n", l.titulo);
                printf("%d\n", l.ano_publicacao);
        ...
        if(profundidade % 2 == 0) {
            ...
            bool e = consultaFaixaAnosUtil(a1, a2, profundidade % 2 == 0 ? no_a.esq : no_b.esq, index * 2, profundidade + 1,offset + bit_a + offset_a_1 + offset_b_1, filename_e);
            ...
            bool d = consultaFaixaAnosUtil(a1, a2, profundidade % 2 == 0 ? no_a.dir : no_b.dir, (index * 2) + 1,profundidade + 1, offset + bit_a + offset_a_2 + offset_b_2, filename_d);
            return e || d;
        }else{
            ...
            if (a1 <= no_b.ano) {
                ...
                e = consultaFaixaAnosUtil(a1, a2, profundidade % 2 == 0 ? no_a.esq : no_b.esq, index * 2, profundidade + 1,offset + bit_a + offset_a + offset_b, filename_e);
            }
            ...
            if(a2 >= no_b.ano){
                ...
                d = consultaFaixaAnosUtil(a1, a2, profundidade % 2 == 0 ? no_a.dir : no_b.dir, (index * 2) + 1,profundidade + 1, offset + bit_a + offset_a + offset_b, filename_d);
            }
...
bool consultaFaixaAnos(int a1, int a2) {
    char filename[21] = "";
    return consultaFaixaAnosUtil(a1, a2, true, 1, 0, 0, filename);
}
